...
class CategoryList extends StatelessWidget {
  ...
  final List<categorymodel> categories = [
    ...
    categorymodel(name: 'entertainment', imagepath: 'assets/entertaiment.avif'),
    categorymodel(name: 'general', imagepath: 'assets/generalnews2.jpeg'),
    categorymodel(name: 'health', imagepath: 'assets/health.avif'),
    categorymodel(name: 'science', imagepath: 'assets/science.avif'),
    categorymodel(name: 'sports', imagepath: 'assets/sports2.jpeg'),
